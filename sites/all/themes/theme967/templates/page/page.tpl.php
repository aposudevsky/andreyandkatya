			...
			<?php endif;
				...
				<div class="container-12">
					<div class="grid-12">
                        ...
                        <!--
						<?php if ( $is_front ) : ?>
							<a rel="nofollow" href="http://www.templatemonster.com/category/italian-restaurant-drupal-themes/" target="_blank">Italian Restaurant Drupal Themes at TemplateMonster.com</a>
						<?php endif; ?>
						-->
					</div>
				</div>
